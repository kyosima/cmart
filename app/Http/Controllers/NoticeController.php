        ...
        switch($type){
            case 1:
                $notice = Notice::create([
                    'title' => 'Hệ thống',
                    'slug' => 'thay-doi-dinh-danh-khach-hang'.date('d-m-Y-H-i-s').time(),
            ...
            case 2:
                $notice = Notice::create([
                    'title' => 'Hệ thống',
                    'slug' => 'thay-doi-thong-tin-'.date('d-m-Y-H-i-s').time(),
            ...
            case 3:
                $notice = Notice::create([
                    'title' => 'Hệ thống',
                    'slug' => 'thay-doi-so-du-tien-tich-luy'.date('d-m-Y-H-i-s').time(),
            ...
            case 4:
                $notice = Notice::create([
                    'title' => 'Hệ thống',
                    'slug' => 'thay-doi-trang-thai-don-hang'.date('d-m-Y-H-i-s').time(),
