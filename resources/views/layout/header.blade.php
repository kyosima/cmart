...
<header class="header-site">
    <a href="#" title="Sức khỏe">
        <img src="https://japana.vn/uploads/banner/1629687032-topbar-new-pc.gif?1631760537" alt="Sức khỏe"
        ...
        <div class="container">
            <div class="d-flex flex-lg-row flex-md-row flex-column align-items-center ">
                <div class="logo-header ">
                    <h1 title="Siêu thị Nhật Bản Japapa.vn" style="margin: 0;">
                        <a href="#" title="Siêu thị Nhật Bản Japana.vn">
                            <img src="https://japana.vn/uploads/system/1549872401-logo.svg"
                ...
                <div class="cate-menu" id="main-menu">
                    <p class="title-cate"> Danh mục sản phẩm <a href="#sub-menu" data-toggle="collapse"
                            data-parent="#main-menu" class="fas fa-bars"></a></p>
                    <div class="collapse list-group-menu" id="sub-menu">
                        <li class="has-sub">
                            <a href="#" title="Sản Phẩm Bán Chạy">
                                <img src="https://japana.vn/uploads/category/1612510003-1557111695-asset-10.png"
                        ...
                        <li class="has-sub">
                            <a href="#" title="Collagen">
                                <img src="https://japana.vn/uploads/category/1545300977-collagen.png"
                                    alt="Collagen">
                        ...
                        <li class="has-sub">
                            <a href="https://japana.vn/thuc-pham-lam-dep/" title="Thực Phẩm Làm Đẹp">
                                <img src="https://japana.vn/uploads/category/1536632955-icon2.png"
                                    alt="Thực Phẩm Làm Đẹp">
                            ...
                            <ul>
                                ...
                                <li><a href="https://japana.vn/giam-den-nghe-den-toi-den/"
                                        title="Giấm Đen - Nghệ Đen - Tỏi Đen">
                                        Giấm Đen - Nghệ Đen - Tỏi Đen</a>
                                </li>
                                <li><a href="https://japana.vn/sua-ong-chua-chong-lao-hoa/"
                                        title="Sữa Ong Chúa - Chống Lão Hóa">
                        ...
                        <li class="has-sub">
                            <a href="https://japana.vn/thuc-pham-chuc-nang/" title="Chăm Sóc Sức Khỏe">
                                <img src="https://japana.vn/uploads/category/1536633007-icon5.png"
                            ...
                            <ul>
                                ...
                                <li><a href="https://japana.vn/ho-tro-dieu-tri-ung-thu/"
                                ...
                                <li><a href="https://japana.vn/ho-tro-dieu-tri-tai-bien/"
                                        title="Hỗ Trợ Điều Trị Tai Biến">
                                ...
                                <li><a href="https://japana.vn/suc-khoe-sinh-ly-nu/"
                                        title="Sức Khỏe &amp; Sinh Lý Nữ">
                                        Sức Khỏe &amp; Sinh Lý Nữ</a>
                                </li>
                                <li><a href="https://japana.vn/bo-mat/" title="Chăm Sóc Mắt">
                                        Chăm Sóc Mắt</a>
                                </li>
                                <li><a href="https://japana.vn/cham-soc-he-tieu-hoa-1/"
                    ...
                    <div class="box-search">
                        <form method="GET" name="frm" id="frm" action="#" enctype="multipart/form-data">
                            <div class="form-group">
                                <input autocomplete="off" x-webkit-speech_off=""
                                    x-webkit-grammar_off="builtin:search" id="search" name="search"
                                    class="form-control ipt-search" placeholder="Tìm kiếm sản phẩm ..." type="text"
                                    value="">
                                <button onclick="searchitem.gotolink('/search.jp?q=');" type="button"
                                    class="icon-search"><i class="fas fa-search"></i></button>
                                <div id="showsearch">
        ...
        <div class="container">
            ...
            <form method="GET" name="frm" id="frm" action="#" enctype="multipart/form-data" class="form-search">
                <div class="header-search">
                    ...
                    <input class="form-control ipt-search" type="text" placeholder="Tìm kiếm sản phẩm..."
        ...
        <div class="custumtab">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="list">
                    <div class="box-tab">
                        <div class="menu-mobile">
                            ...
                            <div class="item ">
                                <button class="title" type="button" data-toggle="collapse"
                            ...
                            <div class="item ">
                                <button class="title" type="button" data-toggle="collapse"
                                    data-target="#collapse3" aria-expanded="flase" aria-controls="collapse3">
                            ...
                            <div class="item">
                                <h4 class="title">
                                    <a href="#" title="Giảm cân">
                                        <img src="https://japana.vn/uploads/category/1536632988-icon4.png"
                                            alt="Giảm cân">
                                        Giảm cân </a>
                                    <span class="expand-menu">
                            ...
                            <div class="item ">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Trang Điểm">
                                        <img src="https://japana.vn/uploads/category/1539922102-Make-up.png"
                                            alt="Trang Điểm">
                                        Trang Điểm </a>
                                    <span class="expand-menu">
                                        <i class="fas fa-angle-right"></i>
                            ...
                            <div class="item ">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Chăm Sóc Da Mặt">
                                        <img src="https://japana.vn/uploads/category/1536633054-icon7.png"
                                            alt="Chăm Sóc Da Mặt">
                                        Chăm Sóc Da Mặt </a>
                                    <span class="expand-menu">
                                        <i class="fas fa-angle-right"></i>
                            ...
                            <div class="item ">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Chăm Sóc Cơ Thể">
                                        <img src="https://japana.vn/uploads/category/1536633071-icon8.png"
                                            alt="Chăm Sóc Cơ Thể">
                                        Chăm Sóc Cơ Thể </a>
                                    <span class="expand-menu">
                                        <i class="fas fa-angle-right"></i>
                                ...
                                <ul id="collapse7" class="collapse sub-nav">
                                    ...
                                    <li>
                                        <a title="Chăm Sóc Tóc" href="https://japana.vn/dau-goi-dau-xa/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Chăm Sóc Tóc </a>
                                    </li>
                                    <li>
                                        <a title="Sữa Tắm" href="https://japana.vn/sua-tam/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Sữa Tắm </a>
                                    </li>
                                    <li>
                                        <a title="Dưỡng Thể" href="https://japana.vn/kem-duong-toan-than/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Dưỡng Thể </a>
                                    </li>
                                    <li>
                                        <a title="Vệ Sinh Cá Nhân"
                                            href="https://japana.vn/cham-soc-ve-sinh-ca-nhan/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Vệ Sinh Cá Nhân </a>
                                    </li>
                                    <li>
                                        <a title="Tẩy Tế Bào Chết" href="https://japana.vn/tay-te-bao-chet/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Tẩy Tế Bào Chết </a>
                                    </li>
                                    <li>
                                        <a title="Bộ Chăm Sóc Cơ Thể" href="https://japana.vn/combo-san-pham/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                            ...
                            <div class="item">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Mẹ &amp; Bé">
                                        <img src="https://japana.vn/uploads/category/1536633117-icon9.png"
                                            alt="Mẹ &amp; Bé">
                                        Mẹ &amp; Bé </a>
                                    <span class="expand-menu">
                                        <i class="fas fa-angle-right"></i>
                                ...
                                <ul id="collapse8" class="collapse sub-nav">
                                    <li>
                                        <a title="Sữa Nhật" href="https://japana.vn/sua-nhat/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Sữa Nhật </a>
                                    </li>
                                    <li>
                                        <a title="Bỉm - Tã Nhật" href="https://japana.vn/bim-ta-cho-be/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Bỉm - Tã Nhật </a>
                                    </li>
                                    <li>
                                        <a title="Bình Sữa - Phụ Kiện"
                                            href="https://japana.vn/binh-sua-va-phu-kien/" class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Bình Sữa - Phụ Kiện </a>
                                    </li>
                                    <li>
                                        <a title="Ngũ Cốc Nhật Bản"
                                            href="https://japana.vn/ngu-coc-dinh-duong-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Ngũ Cốc Nhật Bản </a>
                                    </li>
                                    <li>
                                        <a title="Thực Phẩm Ăn Dặm"
                                            href="https://japana.vn/sua-va-thuc-pham-cho-be/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Thực Phẩm Ăn Dặm </a>
                                    </li>
                                    <li>
                                        <a title="Sức Khỏe Cho Bé" href="https://japana.vn/be-khoe/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Sức Khỏe Cho Bé </a>
                                    </li>
                                    <li>
                                        <a title="Thực Phẩm Tăng Chiều Cao"
                                            href="https://japana.vn/thuoc-tang-chieu-cao/" class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Thực Phẩm Tăng Chiều Cao </a>
                                    </li>
                                    <li>
                                        <a title="Chăm Sóc Vệ Sinh"
                                            href="https://japana.vn/cham-soc-ve-sinh-cho-be/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Chăm Sóc Vệ Sinh </a>
                                    </li>
                                    <li>
                                        <a title="Cặp Chống Lưng Gù"
                                            href="https://japana.vn/cap-chong-lung-gu-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Cặp Chống Lưng Gù </a>
                                    </li>
                                    <li>
                                        <a title="Dành Cho Mẹ" href="https://japana.vn/danh-cho-me/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Dành Cho Mẹ </a>
                                    </li>
                            ...
                            <div class="item">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Nhà Cửa &amp; Đời Sống">
                                        <img src="https://japana.vn/uploads/category/1536633130-icon10.png"
                                ...
                                <ul id="collapse9" class="collapse sub-nav">
                                    <li>
                                        <a title="Bình Giữ Nhiệt" href="https://japana.vn/binh-giu-nhiet/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Bình Giữ Nhiệt </a>
                                    </li>
                                    <li>
                                        <a title="Hộp Đựng Thức Ăn" href="https://japana.vn/hop-dung-thuc-an/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Hộp Đựng Thức Ăn </a>
                                    </li>
                                    <li>
                                        <a title="Nồi Cơm Điện Nhật Bản"
                                            href="https://japana.vn/noi-com-dien-nhat-ban/" class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Nồi Cơm Điện Nhật Bản </a>
                                    </li>
                                    <li>
                                        <a title="Nồi Ủ Nhật Bản" href="https://japana.vn/noi-u-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Nồi Ủ Nhật Bản </a>
                                    </li>
                                    <li>
                                        <a title="Bình Thủy - Phích Nước"
                                            href="https://japana.vn/binh-thuy-phich-nuoc/" class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Bình Thủy - Phích Nước </a>
                                    </li>
                                    <li>
                                        <a title="Máy Sấy Tóc" href="https://japana.vn/may-say-toc/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Máy Sấy Tóc </a>
                                    </li>
                                    ...
                                    <li>
                                        <a title="Máy Xay Đa Năng" href="https://japana.vn/may-xay-da-nang/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Máy Xay Đa Năng </a>
                                    </li>
                                    <li>
                                        <a title="Lò Vi Sóng" href="https://japana.vn/lo-vi-song/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Lò Vi Sóng </a>
                                    </li>
                                    <li>
                                        <a title="Máy Hút Bụi" href="https://japana.vn/may-hut-bui/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Máy Hút Bụi </a>
                                    </li>
                                    <li>
                                        <a title="Giặt Ủi &amp; Vệ Sinh Nhà Cửa"
                                            href="https://japana.vn/giat-ui-va-ve-sinh-nha-cua/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Giặt Ủi &amp; Vệ Sinh Nhà Cửa </a>
                                    </li>
                                    <li>
                                        <a title="Máy Lọc Nước" href="https://japana.vn/may-loc-nuoc/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Máy Lọc Nước </a>
                                    </li>
                                    <li>
                                        <a title="Dụng Cụ &amp; Thiết Bị Gia Đình"
                                            href="https://japana.vn/dung-cu-thiet-bi-gia-dinh/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Dụng Cụ &amp; Thiết Bị Gia Đình </a>
                                    </li>
                                    <li>
                                        <a title="Nội Thất" href="https://japana.vn/noi-that-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Nội Thất </a>
                                    </li>
                            ...
                            <div class="item">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="https://japana.vn/thuc-pham-nhat-ban/" title="Thực Phẩm Nhật Bản">
                                        <img src="https://japana.vn/uploads/category/1536633142-icon11.png"
                                ...
                                <ul id="collapse10" class="collapse sub-nav">
                                    <li>
                                        <a title="Bánh Kẹo" href="https://japana.vn/banh-keo-rong-bien/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Bánh Kẹo </a>
                                    </li>
                                    <li>
                                        <a title="Trà Nhật Bản" href="https://japana.vn/tra-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Trà Nhật Bản </a>
                                    </li>
                                    <li>
                                        <a title="Hộp Quà Tết" href="https://japana.vn/gio-qua-tet/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Hộp Quà Tết </a>
                                    </li>
                                    <li>
                                        <a title="Rượu Nhật Bản" href="https://japana.vn/ruou-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Rượu Nhật Bản </a>
                                    </li>
                                    <li>
                                        <a title="Đồ Uống &amp; Giải Khát"
                                            href="https://japana.vn/do-uong-giai-khat/" class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Đồ Uống &amp; Giải Khát </a>
                                    </li>
                                    <li>
                                        <a title="Thực Phẩm Khô" href="https://japana.vn/thuc-pham-kho/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Thực Phẩm Khô </a>
                                    </li>
                                    <li>
                                        <a title="Gia Vị" href="https://japana.vn/gia-vi-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Gia Vị </a>
                                    </li>
                            ...
                            <div class="item">
                                <button class="title" type="button" data-toggle="collapse"
                                    ...
                                    <a href="#" title="Hương Thơm Nhật Bản">
                                        <img src="https://japana.vn/uploads/category/1574674189-huong-thom-nhat-ban.png"
                                            alt="Hương Thơm Nhật Bản">
                                ...
                                <ul id="collapse11" class="collapse sub-nav">
                                    <li>
                                        <a title="Trầm Hương" href="https://japana.vn/tram-huong-nhat-ban/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Trầm Hương </a>
                                    </li>
                                    <li>
                                        <a title="Đầu Đốt - Giá Đỡ" href="https://japana.vn/dau-dot-gia-do/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                                            Đầu Đốt - Giá Đỡ </a>
                                    </li>
                                    <li>
                                        <a title="Card - Sáp Thơm Ô tô" href="https://japana.vn/card-sap-thom-o-to/"
                                            class="sub-nav-item">
                                            <i class="icon-m icon-child-m"></i>
                ...
                <div role="tabpanel" class="tab-pane " id="acc">
                    <div class="box-item">
                        <ul>
                            <li><a id="register-btn" href="#" title="title"><i
                                        class="fas fa-user"></i><span>Đăng ký tài khoản</span></a></li>
                            <li><a id="login-btn" href="#" title="title"><i
                                        class="fas fa-sign-in-alt"></i></i><span>Đăng nhập</span></a></li>
                            <li><a href="#" title="title"><i class="far fa-sticky-note"></i><span>Tra cứu đơn
                                        hàng</span></a></li>
                        </ul>
                    </div>
...
<div class="toolbar2 ">
    <ul class="d-flex justify-content-around  align-items-center">
        <li><a id="home" href="https://japana.vn/" title="Trang chủ"><i
                    class="icon-2020 icon-home-2020"></i><br><span>Trang chủ</span></a></li>
        <li><a id="goidien" href="javascript:callme('tel:(028) 7108 8889')" title="phone"><i
                    class="icon-2020 icon-phone-2020"></i><br><span>Gọi điện</span></a></li>
        <li><a id="chatzalo" href="javascript:callme('https://zalo.me/1360579267495118428')" title="zalo"><i
                    class="icon-2020 icon-zalo-2020"></i><br><span>Chat zalo</span></a></li>
        <li><a id="chatfb" href="javascript:callme('https://www.messenger.com/t/japana.sieuthinhat')"
                title="facebook"><i class="icon-2020 icon-facebook-2020"></i><br><span>Chat facebook</span></a>
        </li>
    </ul>
</div>
