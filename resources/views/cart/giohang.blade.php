                ...
                <div class="cart-block" id="store-b-{{ $store->id }}">
                    ...
                    <div id="store-cart">
                        ...
                        <div class="row cart_item">
                            ...
                            <div class="col-lg-2 col-md-2 col-6 d-flex align-items-center justify-content-center">
                                <a href="{{ route('san-pham.show', $row->model->slug) }}" class="cart-item-name">{{ $row->name }}</a>
                            </div>
                            ...
                            <div class="col-lg-1 col-md-1 col-6 d-flex align-items-center justify-content-center">
                                <input type="number" class="product-qty soluong form-control form-control-sm text-center" value="{{ $row->qty }}" step="1" min="1" max="" name="qty" data-rowid="{{ $row->rowId }}" data-url="{{ route('cart.update') }}" data-storeid="{{ $store->id }}" title="SL" size="3" pattern="[0-9]*" inputmode="numeric">
                            </div>
                            <div class="col-lg-1 col-md-1 col-12 text-center d-flex align-items-center justify-content-center">
                                <img src="https://i.imgur.com/bI4oD5C.png" width="15px" class="remove" onclick="removeRowCart(this)" data-url="{{ route('cart.delete') }}" data-rowid="{{ $row->rowId }}" data-storeid="{{ $store->id }}" aria-label="Xóa sản phẩm">
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <li class="cart_options_col">
                        <input type="number" class="product-qty soluong form-control form-control-sm text-center" value="{{ $row->qty }}" step="1" min="1" max="" name="qty" value="{{ $row->qty }}" data-rowid="{{ $row->rowId }}" data-url="{{ route('cart.update') }}" data-storeid="{{ $store->id }}" title="SL" size="3" pattern="[0-9]*" inputmode="numeric">
                    </li>
                    ...
                    <li class="cart_del_col">
                        <img src="https://i.imgur.com/bI4oD5C.png" class="remove" onclick="removeRowCart(this)" data-url="{{ route('cart.delete') }}" data-rowid="{{ $row->rowId }}" data-storeid="{{ $store->id }}" aria-label="Xóa sản phẩm">
                    </li>
                    </ul>
                    @endforeach
                </div> --}}
    ...
    <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
        <div class="form-checkout">
            <form action="{{ route('cart.checkout') }}" method="post">
                ...
                <div class="d-md-flex d-flex @if (!in_array(Auth::user()->level, [3, 4])) justify-content-center @else justify-content-around @endif">
                    <div class="">
