                            ...
                            <div class="col-lg-1 col-md-1 col-xs-3">
                                        ...
                                        @foreach ($cart->content() as $row)
                                            <div class="row cart_item">
                                                <div
                                                    class="col-lg-2 col-md-2 col-xs-12 d-flex align-items-center  ">
                                                ...
                                                <div
                                                class="col-lg-2 col-md-2 col-6 d-flex align-items-center ">
                                                <a href="{{ route('san-pham.show', $row->model->slug) }}"
                                                ...
                                                <div class="col-lg-2 col-md-2 col-5 ml-3 d-block d-sm-none">
                                                    ...
                                                    <div
                                                        class="col-lg-1 col-md-1 col-4 d-flex align-items-center ">
                                                    ...
                                                    <div
                                                        class="col-lg-1 col-md-2 col-4 d-flex align-items-center ">
                                                ...
                                                <div
                                                    class="col-lg-1 col-md-1 col-6 d-flex align-items-center ">
                                                    <input type="number"
                                                ...
                                                <div
                                                    class="col-lg-1 col-md-1 col-12  d-flex align-items-center ">
