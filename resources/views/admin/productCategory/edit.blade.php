                    ...
                    <div class="row">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div class="form-group my-2">
                                    <input id="ckfinder-input-1" type="hidden" name="feature_img" class="form-control"
                                        value="{{ old('feature_img', $proCat->feature_img) }}" readonly required>
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="form-group my-2">
                                    <input id="ckfinder-input-2" type="hidden" name="gallery_img" data-type="multiple"
                                        data-hasid="{{ $proCat->id }}" readonly class="form-control"
                                                ...
                                                @if ($img != null || $img != '')
                                                    <div class="col-md-3">
                                                        <span style="cursor: pointer;" data-id=''
                                                            data-url="{{ trim($img) }}" class="delete_gallery">
                                        ...
                                        @else
                                            ...
                                            @if ($proCat->gallery != null)
                                                @foreach ($gallery as $img)
                                                    <div class="col-md-3">
                                                        <span style="cursor: pointer;" data-id='{{ $proCat->id }}'
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                                    ...
                                                    <div class="form-group d-flex">
                                                        <div class="input-group-btn" id="blog-status">
                                                            <select name="blog_status" class="selectpicker form-control">
                                                                <option value="0" {{ $proCat->status == 0 ? 'selected' : '' }}>
                                                                    Ngưng hoạt động</option>
                                                                <option value="1" {{ $proCat->status == 1 ? 'selected' : '' }}>Hoạt
                                                                    động</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-12 control-label text-left">Thứ tự ưu tiên</label>
                                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 control-label text-left">Danh mục cha<span
                                                class="required" aria-required="true">(*)</span>:</label>
                                        <div class="col-md-12">
                                            <select class="form-control" name="proCatParent" required id="select-cate-parent">
                                                @if ($proCat->category_parent == 0)
                                                    <option value="0" selected>None</option>
                                                @else
                                                    @if (old('proCatParent'))
                                                        @php
                                                            $new_id = old('proCatParent');
                                                        @endphp
                                                    <option value="{{ $new_id }}" selected="selected">{{ App\Models\ProductCategory::where('id', $new_id)->value('name') }}</option>
                                                    @else 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="selectpicker form-control" name="linkProCat" required id="select-cate-link">
                                                @if ($proCat->link_to_category == 0)
                                                    <option value="0" selected>None</option>
                                                @else
                                                    @if (old('linkProCat'))
                                                        @php
                                                            $new_link_id = old('linkProCat');
                                                        @endphp
                                                    <option value="{{ $new_link_id }}" selected="selected">{{ App\Models\ProductCategory::where('id', $new_link_id)->value('name') }}</option>
                                                    @else 
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="row">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="meta_description" id="meta_description" class="form-control"
                                                rows="3" placeholder="Meta description tối đa 150 - 160 ký tự"
                                                maxlength="160">{{ old('meta_description', $proCat->meta_desc) }}</textarea>
                                            <div id="the-count">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-2">
                                        <label class="col-md-12 control-label vertical text-left">Meta keyword (cách nhau
                                            bởi dấu phẩy)</label>
                                        <div class="col-md-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#select-cate-parent').select2({
                ...
                delay: 250,
                ajax: {
                    url: "{{route('nganh-nhom-hang.getProCat')}}",
                    dataType: 'json',
