...
@section('title', 'Sản phẩm-Thêm sản phẩm')
                ...
                <form action="{{ route('product.store') }}" method="post" data-parsley-validate="">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="cart-title">Thêm sản phẩm</h5>
                            <div class="card-tool">
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div class="form-group my-2">
                                            <input id="ckfinder-input-1" type="hidden" required
                                                ...
                                                class="form-control" value="public/storage/images/default-image.png">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="form-group my-2">
                                            <input id="ckfinder-input-2" type="hidden" name="gallery"
                                                data-type="multiple" class="form-control"
                                                value="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <input type="number" step="0.1" min="0"
                                                                name="length" class="form-control" value="0" required
                                                                data-parsley-required-message="Không được để trống">
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="control-label">Chiều cao
                                                                (cm):</label>
                                                            <input type="number" step="0.1" min="0"
                                                                name="height" class="form-control" value="0" required
                                                                data-parsley-required-message="Không được để trống">
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="control-label">Chiều rộng
                                                                (cm):</label>
                                                            <input type="number" step="0.1" min="0"
                                                                name="width" class="form-control" value="0" required
                                                                data-parsley-required-message="Không được để trống">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="selectIsVariation"
                                                                    ...
                                                                    <option value="0">Sản phẩm
                                                                        thường</option>
                                                                    <option value="1">Sản phẩm có
                                                                        biến thể</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">Phân loại giá sản
                                                                    phẩm<sup class="text-danger">*</sup>:</label>
                                                                <select class="form-control"
                                                                    name="is_ecard" required
                                                                    data-parsley-required-message="Không được để trống">
                                                                    <option value="0">Thường(đ)</option>
                                                                    <option value="1">E-card(%)</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div id="productPriceForm" class="price-price-form">
                                                    @include('admin.product.price.price_normal',
                                                        compact($user_prices))
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select class="form-control multiple-payments" name="payment_ids[]"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 control-label vertical text-left text-danger">Mô tả chi
                                            tiết:</label>
                                        <div class="col-md-12">
                                            <textarea name="description" id="description" class="form-control" rows="3" placeholder="...">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
