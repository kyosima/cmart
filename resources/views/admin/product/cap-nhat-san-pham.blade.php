                    ...
                    <div class="col-sm-9">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="selectpicker form-control" id="selectCategory" name="category_parent" required>
                                            <option value="{{$product->category_id}}">{{$product->productCategory->name}}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="is_ecard"><input type="checkbox" name="is_ecard" id="is_ecard" value="1" @if($product->is_ecard == 1) checked @endif> Sản phẩm E-Card</label>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select class="selectpicker form-control" name="tax"
                                                    ...
                                                    @else
                                                        <option value="KKK" {{$product->productPrice->tax == 'KKK' ? 'selected' : ''}}>KKK</option>
                                                        <option value="KTT" {{$product->productPrice->tax == 'KTT' ? 'selected' : ''}}>KTT</option>
