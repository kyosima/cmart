...
@section('content')
    <div class="m-3">
        <div class="row">
            <div class="col-sm-12">
                <form action="{{ route('transpot.cross_province.variation.update_price', $transpot_price_detail->id) }}" method="post"
                    enctype="multipart/form">
                    @csrf
                    @method('put')
                    <div class="card">
                        <div class="card-header">
                            <h5 class="cart-title"><a
                                    href="{{ route('transpot.cross_province.variation.show', $transpot_price_detail->transpot_variation_id) }}"><i
                                        class="fas fa-chevron-left"></i></a> Bảng phí vận chuyển từ
                                {{ $transpot_price_detail->transpot_variation->province_from->tentinhthanh }} tới
                                {{ $transpot_price_detail->transpot_variation->province_to->tentinhthanh }}</h5>
                            <div class="card-tool">
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form">
                                            <div class="form-group">
                                                <label for="">Định danh khách hàng</label>
                                                <input type="text" class="form-control"
                                                    value="{{ $transpot_price_detail->user_level->name }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Hình thức vận chuyển</label>
                                                <input type="text" class="form-control"
                                                    value="{{ $transpot_price_detail->type == 1 ? 'Tiêu chuẩn' : 'Tốc độ' }}"
                                                    readonly>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="ip_feeMin" type="text" min="0" class="form-control"
                                            ...
                                            <div class="form-group">
                                                <label for="">Phí mặc định</label>
                                                <input id="ip_feeDefault" type="text" min="0" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="ip_feePackage" type="text" min="0" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="ip_feeWeight" type="text" min="0" class="form-control"
                                                    value="{{ $transpot_price_detail->fee_weight }}" required
                                                    data-parsley-required-message="Không được để trống">
                                                <input id="feeWeight" type="hidden" name="fee_weight"
                                                    value="{{ $transpot_price_detail->fee_weight }}" required>
                                            </div>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        easyNumberSeparator({
            selector: '#ip_feeWeight',
            separator: '.',
            resultInput: '#feeWeight',
        })
    </script>
@endpush
