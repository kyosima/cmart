...
@section('title', 'Dịch vụ vận chuyển Nội tỉnh')
...
@section('content')
    <div class="m-3">
        <div class="row">
            <div class="col-sm-12">
                <form action="{{ route('transpot.province.update', $transpot_price_detail->id) }}" method="post"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form">
                                            ...
                                            <div class="form-group">
                                                <label for="">Phí suất khoảng cách</label>
                                                <input id="ip_feeDistance" type="text" min="0" 
                                                    class="form-control" value="{{ $transpot_price_detail->fee_distance }}"
                                                    required data-parsley-required-message="Không được để trống">
                                                <input id="feeDistance" type="hidden" name="fee_distance"
                                                    value="{{ $transpot_price_detail->fee_distance }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        easyNumberSeparator({
            selector: '#ip_feeDistance',
            separator: '.',
            resultInput: '#feeDistance',
        })
    </script>
@endpush
