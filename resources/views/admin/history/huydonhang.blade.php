        ...
        <div class="container pt-4 pb-4">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ asset('admin/lichsudonhanghuy/download/pdf') }}" class="btn btn-primary text-white"
                                style="width: 100%">
                                Xuất PDF</a>
                        </div>
                        <div class="col-6">
                            <a href="{{ asset('admin/lichsudonhanghuy/download/xlsx') }}" class="btn btn-primary text-white"
                                style="width: 100%">
                                Xuất Excel</a>
                        </div>
                    </div>
