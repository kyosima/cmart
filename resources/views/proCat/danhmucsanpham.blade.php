...
@section('content')
    ...
    <section>
                        ...
                        <form action="{{ url('/') . '/' . Request::path() }}" method="get" id="filter_form">
                            ...
                            <aside class="widget">
                                ...
                                <div class="slider-price">
                                    ...
                                    <input type="hidden" name="beginMinPrice" id="minprice1" @if ($beginMinPrice == 0)
                                    value="{{ $minPrice }}"
                                @else
                                    value="{{ $beginMinPrice }}"
        @endif
        ...
        <input type="hidden" name="endMaxPrice" id="maxprice1" @if ($endMaxPrice == 0)
        value="{{ $maxPrice }}"
    @else
        value="{{ $endMaxPrice }}"
        @endif
        ...
        <div class="shop-container col-lg-9 col-md-12 col-sm-12">
            <div class="shop-container-inner">
                <!-- TITLE -->
                <h2 class="title-filter d-none d-lg-block">{{ $proCat->name }} <span>({{ count($products) }} sản
                        phẩm)</span></h2>
                <!-- Bộ lọc -->
