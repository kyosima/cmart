...
<section class="slider">
    <div class="container">
        <div class="fotorama" data-width="100%" data-ratio="4/1">
...
<!-- main -->
<section>
    @if (count($products) < 1) <div class="category-page container">
        <div class="row">
            <div class="col">
                        ...
                        <div id="category_search" class="widget-product-categories">
                            <ul class="check-side category-menu">
                                ...
                                <li class="menu-item menu-item-has-children py-1 has-child menu-border">
                                    ...
                                    @endif
                                    <button class="toggle" data-id="{{ $item->id }}" data-url="{{ route('proCat.getCatChild') }}" onclick="getCategoryChild(this)">
        ...
        <form action="{{ url('/') . '/' . Request::path() }}" method="get" id="filter_form">
            ...
            <aside class="widget thuonghieu">
                ...
                <div class="widget-search">
                    <input autocomplete="off" id="input_brand_search" type="text" class="form-control input_search" placeholder="Tìm kiếm..." onkeyup="searchBrand('brand_search')">
                    <button type="button">
                        <i class="search-icon"></i>
                    </button>
                </div>
        ...
        <div class="shop-container col-lg-9 col-md-12 col-sm-12">
            <div class="shop-container-inner">
                ...
                <div class="filter-cate">
                    ...
                    <select id="filter-products" class="form-control form-control-sm ms-2 d-lg-inline" style="max-width: 200px">
                    ...
                    <div class="item">
                        ...
                        <div class="box-text col-lg-12 col-md-8 col-8">
                            ...
                            <div class="price-wrapper">
                                <span class="price">
                                    <span class="amount">{{ formatPriceOfLevelCate($item) }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
