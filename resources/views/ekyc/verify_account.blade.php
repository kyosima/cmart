                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <ul class="text-justify pl-0" style="list-style: none">
                                    <li>- Quý Khách Hàng vui lòng thực hiện theo hướng dẫn để xác minh nhanh nhân thân với
                                        công nghệ
                                        eKYC.
                                        C-Mart là một trong số các công ty thương mại điện tử tiên phong áp dụng công nghệ
                                        này để xác
                                        minh
                                        Khách Hàng là chính chủ của danh tính cung cấp chỉ trong vài phút.</li>

                                    <li>- Giới thiệu sơ lược về công nghệ eKYC: eKYC là hình thức định danh Khách Hàng điện
                                        tử, đã được
                                        Nhà
                                        nước chấp thuận cấp phép. Theo Quyết định 149/QĐ-TTg về việc phê duyệt Chiến lược
                                        tài chính toàn
                                        diện quốc gia đến năm 2025, định hướng đến năm 2030 của Thủ tướng Chính phủ “cho
                                        phép áp dụng
                                        quy
                                        trình nhận biết khách hàng đơn giản và gián tiếp từ xa bằng phương thức điện tử trực
                                        tuyến
                                        (eKYC)
                                        đối với việc mở tài khoản tại các tổ chức được cấp phép để phục vụ cho nhu cầu thanh
                                        toán giá
                                        trị nhỏ của cá nhân và doanh nghiệp”. Điều này góp phần giúp xác minh danh tính của
                                        Khách Hàng
                                        trực
                                        tuyến và đánh giá rủi ro, phát hiện lừa đảo trong mỗi giao dịch,...</li>

                                    <li>- C-Mart luôn muốn mang đến những trải nghiệm văn hóa phục vụ chuyên nghiệp, an
                                        toàn. Vì thế,
                                        C-Mart
                                        đã lựa chọn công nghệ hiện đại nhất để nâng cao độ bảo mật, nâng cao trải nghiệm
                                        Khách Hàng, đơn
                                        giản hóa các thủ tục. Trong sự bảo vệ tối đa dành cho Quý Khách Hàng, mang đến sự an
                                        tâm khi
                                        giao
                                        dịch cùng C-Mart, mà vẫn đáp ứng nhu cầu của Khách Hàng ngày càng tốt hơn theo hướng
                                        One Stop
                                        Shopping (Khách Hàng chỉ truy cập một nơi và đáp ứng mọi nhu cầu giao dịch của
                                        mình).</li>

                                    <li>- Xin Quý Khách Hàng tin tưởng rằng C-Mart xem việc bảo mật thông tin là điều vô
                                        cùng nghiêm
                                        túc, và chúng tôi thực hiện vô cùng nghiêm ngặt. Các thông tin này CHỈ DÙNG ĐỂ XÁC
                                        MINH NHÂN THÂN nhằm
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="verify_image_front">
                        <label for="">Mời chụp mặt trước giấy tờ tùy thân</label>
                    ...
                    <div class="verify_image_back">
                        <label for="">Mời chụp mặt sau giấy tờ tùy thân</label>
                    ...
                    <div class="verify_image_portrait">
                        <label for="">Mời chụp chân dung</label>
