    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8 mx-auto">
            ...
            <div class="my-4">
                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl">
                            ...
                            <img class="img_avt" for="img_avatar" src="{{ $profileUser->avatar }}" width="150px" height="150px" />
                            ...
                            @else
                            <img class="img_avt" for="img_avatar" class="rounded-circle mt-3" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
                            <input type="file" class="form-control" name="avatar" id="img_avatar" style="display: none">
                            {{-- <label for="img_avatar" class="btn btn-primary profile-button mt-2">Ảnh chân dung</label> --}}
                            @endif
                        </div>
                    ...
                    <div class="col">
                        ...
                        @else
                        @if ($check == 0)
                        <button class="w-100 btn btn-info" data-toggle="modal" data-target="#modalrequestekyc">Gửi yêu cầu thay đổi thông tin</button>

                        <div class="modal fade" id="modalrequestekyc" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <form action="{{ url('thong-tin-tai-khoan') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <img id="imgFileUpload" src="{{ $profileUser->cmnd_image }}" width="100%" style="cursor: pointer" />
                        {{-- <br />
                    ...
                    <div class="form-group">
                        ...
                        <img id="imgFileUpload2" src="{{ $profileUser->cmnd_image2 }}" width="100%" style="cursor: pointer" />
                        {{-- <br />
                    ...
                    <div class="form-group row">
                        ...
                        <div class=" col-sm-10">
                            <input type="text" name="address" class="form-control" value="{{ $profileUser->address }}" placeholder="Địa chỉ chi tiết" required readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        {{-- <div class="form-group col-md-6">
                    ...
                    <div class="col-sm-10">
                        <select name="sel_province" class="form-control " data-placeholder="---Chọn tỉnh thành---" required disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="sel_district" class="form-control " data-placeholder="---Chọn quận huyện---" required disabled>
            ...
            <div class="form-group row">
                ...
                <div class=" col-sm-10">
                    <select name="sel_ward" class="form-control " data-placeholder="---Chọn phường xã---" required disabled>
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center experience"><span><input type="checkbox" id="changePassword" name="changePassword"> Đổi mật khẩu</span>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword5">Nhập mật khẩu mới </label>
                        <input type="password" class="form-control password" name="password" placeholder="Mời nhập mật khẩu mới từ 8 kí tự" minlength="8" disabled>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword6">Nhập lại mật khẩu mới</label>
                        <input type="password" class="form-control password" name="passwordAgain" placeholder="Mời nhập lại mật khẩu mới" minlength="8" disabled>
                    </div>
                </div>
                {{-- <div class="col-md-6">
