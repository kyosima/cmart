            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="group-btns pull-right">
                        ...
                        <a href="#delete-log-modal" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete-log-modal">
...
@section('modals')
{{-- DELETE MODAL --}}
    <div class="modal fade" id="delete-log-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-secondary mr-auto" data-bs-dismiss="modal">@lang('Cancel')</button>
