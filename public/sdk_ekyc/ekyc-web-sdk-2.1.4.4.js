var ekycsdk = function(e) {
    ...
    var S = (e, t, i, n) => {
        ...
        function N() { v.style.display = "block", p.style.display = "none", c > 1024 ? s.style.display = "none" : l.style.display = "none" }

        function U() { c > 1024 ? s.style.display = "block" : l.style.display = "block", v.style.display = "none", p.style.display = "block" }

        function j(e) { e && O.push(e) }
        S.type_document = e;
    ...
    var M = (e, t, i, n) => {
        ...
        function M() { v.style.display = "block", p.style.display = "none", c > 1024 ? s.style.display = "none" : l.style.display = "none" }
    ...
    var B = (e, t, i, n) => {
        ...
        function U() { v.style.display = "block", p.style.display = "none", c > 1024 ? s.style.display = "none" : l.style.display = "none" }
